...
async function requireOllama(provider: OllamaProvider): Promise<void> {
  ...
  if (!available) {
    throw new Error(
      `Ollama not reachable at ${OLLAMA_ENDPOINT} — start Ollama (ollama pull ${OLLAMA_MODEL}) ` +
        'or run only the unit tests via `pnpm test`.',
    );
  }
}
...
function getFormValues(form: HTMLFormElement) {
  return {
    ...
    lastMaintenanceDate:
      form.querySelector<HTMLInputElement>('[name="lastMaintenanceDate"]')?.value || '',
...
describe('Ollama Integration Tests', () => {
  ...
  it(
    'Test 1: extracts all fields when all information is present',
    async () => {
  ...
  it(
    'Test 2: handles missing serial number',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 3: handles missing maintenance date',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 4: handles missing remarks',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 5: handles missing manufacturer and model',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 6: handles only remarks provided',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 7: handles only serial number provided',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 8: handles nonsensical inputs',
    async () => {
      const form = createParagliderForm();
      const input = 'test';
  ...
  it(
    'Test 9: extracts from long text with all information',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 10: extracts from long text with some missing info',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 11: extracts from long text without remarks',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 12: extracts from long text with complex information',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 13: extracts from long text with missing serial and remarks',
    async () => {
      const form = createParagliderForm();
  ...
  it(
    'Test 14: extracts from very complex unstructured text',
    async () => {
      const form = createParagliderForm();
...
function getAdvancedFormValues(form: HTMLFormElement) {
  return {
    ...
    employmentType:
      form.querySelector<HTMLInputElement>('[name="employmentType"]:checked')?.value || '',
    experienceLevel:
      form.querySelector<HTMLInputElement>('[name="experienceLevel"]:checked')?.value || '',
    interest_tech: form.querySelector<HTMLInputElement>('[name="interest_tech"]')?.checked || false,
    interest_sports:
      form.querySelector<HTMLInputElement>('[name="interest_sports"]')?.checked || false,
    interest_arts: form.querySelector<HTMLInputElement>('[name="interest_arts"]')?.checked || false,
    interest_music:
      form.querySelector<HTMLInputElement>('[name="interest_music"]')?.checked || false,
    interest_travel:
      form.querySelector<HTMLInputElement>('[name="interest_travel"]')?.checked || false,
...
describe('Advanced Form Integration Tests', () => {
  ...
  it(
    'Advanced Test 1: fills complete job application with all fields',
    async () => {
  ...
  it(
    'Advanced Test 2: handles natural language introduction',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 3: fills form with minimal required info',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 4: handles contact information only',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 5: handles employment preferences without personal details',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 6: handles freelance developer profile',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 7: handles international applicant with varied date formats',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 8: handles complex paragraph with embedded information',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 9: handles bullet-point style information',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 10: handles only interests and preferences',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 11: handles nonsensical input gracefully',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 12: handles email and phone only',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 13: handles multi-paragraph about section',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 14: handles European address format',
    async () => {
      const form = createAdvancedForm();
  ...
  it(
    'Advanced Test 15: handles all checkboxes scenario',
    async () => {
      const form = createAdvancedForm();
